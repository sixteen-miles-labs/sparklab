...
def test_dsv4_kv_cost_and_floor_parity():
    from sparklab.runtime.kvcache.dsv4_cost_model import _dsv4_swa_ratio, _dsv4_window_floor_pages
    from sparklab.runtime.kvcache.dsv4_paged_pool import DSV4PagedKVCache

    pytest.importorskip("sparklab.runtime.kvcache.dsv4_cost_model")
    from sparklab.runtime.kvcache.dsv4_cost_model import dsv4_auto_cost_model
...
def test_startup_kv_budget_composition():
    ...
    from sparklab.runtime.engine.engine import _startup_kv_budget
...
def test_rebuild_from_config_explicit_num_swa_pages_wins():
    ...
    from sparklab.runtime.kvcache.dsv4_cost_model import _dsv4_pool_sizes
    from sparklab.runtime.kvcache.hybrid_swa_pool import _swa_paged_num_tokens, _swa_pool_floor
...
def test_create_kv_pool_builds_the_right_family():
    ...
    from sparklab.runtime.distributed import set_tp_info, try_get_tp_info
    from sparklab.runtime.kvcache import create_kv_pool
    from sparklab.runtime.kvcache.hybrid_swa_pool import _swa_paged_num_tokens
    from sparklab.runtime.kvcache.hybrid_swa_pool import HybridSWAKVCache
    from sparklab.runtime.kvcache.mha_pool import MHAKVCache
...
def test_validate_rebuild_targets_flow_by_kv_cost_signature():
    ...
    from sparklab.runtime.distributed import set_tp_info, try_get_tp_info
    from sparklab.runtime.kvcache.base import CacheRebuildRejected
    from sparklab.runtime.kvcache.hybrid_swa_pool import HybridSWAKVCache, _swa_pool_floor
    from sparklab.runtime.kvcache.mha_pool import MHAKVCache
