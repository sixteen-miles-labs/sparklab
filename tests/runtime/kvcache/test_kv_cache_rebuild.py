...
def test_hybrid_swa_rebuild_from_config_derives_the_window_per_cache_type():
    ...
    from sparklab.runtime.kvcache.hybrid_swa_pool import _naive_swa_num_tokens, _swa_paged_num_tokens
    from sparklab.runtime.kvcache.hybrid_swa_pool import HybridSWAKVCache
...
def test_dsv4_rebuild_from_config_builds_the_pool_sizes_and_attaches_the_table():
    ...
    from sparklab.runtime.kvcache.dsv4_cost_model import (
        dsv4_kv_unit_bytes,
        dsv4_pool_sizes,
...
def test_dsv4_refresh_seq_state_tracks_page_table_width():
    ...
    from sparklab.utils import align_ceil
    from sparklab.runtime.kvcache.dsv4_paged_pool import DSV4PagedKVCache
