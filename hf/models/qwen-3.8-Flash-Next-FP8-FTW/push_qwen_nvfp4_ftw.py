#!/usr/bin/env python3
"""Upload Qwen NVFP4 FTW model weights to the Hugging Face Hub."""
...
DEFAULT_REPO_ID = "oakmindai/Qwen3.8-Flash-Next-FP8-FTW"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Upload a local Qwen NVFP4 FTW model directory with Hugging Face's "
            "resumable large-folder uploader."
        )
    )
    parser.add_argument(
        "weights_dir",
