...
| [Qwen3.8-Flash-Next](https://huggingface.co/Qwen/Qwen3.8-Flash-Next) | NVFP4 | Certified | 12.51 decode tok/s · 0.870 s warm TTFT · exact 64K context · 60.5 min endurance |
| [DeepSeek V4 Flash](https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash-0731) | DS-FP4 | Preview | 9.217 decode tok/s · 14.045 s warm TTFT on the fixed baseline probe |
