...
from sparklab.runtime.scheduler import SchedulerConfig
...
class ServerArgs(SchedulerConfig):
    ...
    # The terminal shell is attached to this server (sparklab shell --model / sparklab serve --shell-mode).
    ...
    def zmq_frontend_addr(self) -> str:
        return "ipc:///tmp/sparklab_3" + self._unique_suffix

    @property
    def zmq_tokenizer_addr(self) -> str:
        if self.share_tokenizer:
            return self.zmq_detokenizer_addr
        result = "ipc:///tmp/sparklab_4" + self._unique_suffix
...
def parse_args(
    ...
    from sparklab.runtime.kvcache import SUPPORTED_CACHE_MANAGER
    from sparklab.moe import SUPPORTED_MOE_BACKENDS
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(offload, or hybrid when a `sparklab bench bw` profile recommends it); resident "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "step's misses (perfect overlap; needs an `sparklab bench bw` profile, else 1). "
    ...
    # sizing flag at all, default to --moe-cache-auto so a bare `sparklab serve <FTW MoE>` works
