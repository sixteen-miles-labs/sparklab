...
def fused_experts_fp8_block(
    ...
    *, slot_map=None,
    ...
    from sparklab.kernels.triton.fp8_blockscale_moe import fused_experts_fp8_blockscale
...
def fused_experts_decode_fp8_block(
    ...
    assert not apply_router_weight_on_input
    from sparklab.kernels.triton.fp8_blockscale_moe import fused_experts_decode_fp8_blockscale
