...
Ports vLLM/sglang's ``_fused_moe_gguf`` MMVQ path onto SparkLab's offload-cache
...
from sparklab.layers.activation import gelu_and_mul, gelu_tanh_and_mul, silu_and_mul
from sparklab.models.gguf.dequant import GGML_Q4_0
...
def fused_experts_gguf_q4_0(
    ...
    from sparklab.kernels.gguf import ggml_moe_a8_vec
