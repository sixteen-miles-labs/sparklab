...
import torch
from sparklab.moe import BaseMoeBackend
from sparklab.utils import div_ceil, init_logger
...
def fused_topk(
    ...
    from sparklab.kernels.backend import is_triton_kernels_installed
...
def moe_align_block_size(
    ...
    if not is_sgl_kernel_installed():
        from sparklab.kernels.triton.moe_align import (
...
def _get_tuned_moe_configs(
    ...
    config_roots = []
    if env_dir := os.environ.get("SPARKLAB_MOE_CONFIG_DIR"):
...
def fused_experts_impl(
    ...
    from sparklab.kernels import fused_moe_kernel_triton, moe_sum_reduce_triton
    from sparklab.layers import gelu_and_mul, gelu_tanh_and_mul, silu_and_mul
...
def fused_experts_decode_impl(
    ...
    from sparklab.kernels import fused_moe_decode_kernel_triton, moe_sum_reduce_triton
    from sparklab.layers import gelu_and_mul, gelu_tanh_and_mul, silu_and_mul
