...
from sparklab.moe.fused import moe_align_block_size, try_get_optimal_moe_config
...
def _activate_mxfp4(
    ...
    *,
    ...
    if activation == "gpt_oss_swiglu":
        from sparklab.kernels import gpt_oss_swiglu_triton
...
def run_mxfp4_splitk_decode_experts(
    ...
    *,
    ...
    from sparklab.kernels import mxfp4_splitk_gemv_triton
