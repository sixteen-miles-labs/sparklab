...
# otherwise); SPARKLAB_CPU_MOE_FLAG_SYNC=0 opts out entirely.
_FLAG_SYNC = os.getenv("SPARKLAB_CPU_MOE_FLAG_SYNC", "1") != "0"
...
class CpuMoeExecutor:
    ...
    def decode_submit(
        ...
        if self._gpu_prequant:
            ...
            from sparklab.kernels.triton.dsv4.fp8_linear import act_quant_fp8_roundtrip
    ...
    def raise_if_unhealthy(self) -> None:
        ...
        if self._err is not None and bool((self._err != 0).any()):
            raise RuntimeError(
                ...
                "engine, or set SPARKLAB_CPU_MOE_FLAG_SYNC=0 to use the "
