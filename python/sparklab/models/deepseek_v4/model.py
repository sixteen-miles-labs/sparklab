"""DeepSeek-V4-Flash model (engine-native SparkLab port of inference/model.py).
...
sqrtsoftplus / hash MoE), wired onto SparkLab's shared paged engine:

  - KV lives in DSV4-owned paged pools (:class:`~sparklab.runtime.kvcache.dsv4_paged_pool.DSV4PagedKVCache`):
...
Heavy ops are SparkLab Triton kernels. Precision matches the reference (FP8/FP4
