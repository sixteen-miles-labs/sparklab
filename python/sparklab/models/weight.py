...
from sparklab.kernels.pinned import alloc_pinned_tensor, copy_to_pinned_tensor
from sparklab.models.loader import stream_moe_expert_sources
from sparklab.utils import cached_load_hf_config, div_even
...
def load_weight(
    ...
    *,
    ...
    from sparklab.models.config import VISION_KEY_PREFIXES, vision_load_enabled
...
def dummy_nvfp4_expert_sources(config) -> dict[str, list[torch.Tensor]]:
    ...
    H, I = _expert_hidden_size(config), config.moe_intermediate_size
