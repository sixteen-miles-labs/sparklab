"""Gemma 4 GGUF adapter: build the SparkLab ``ModelConfig`` from GGUF metadata.
...
from sparklab.models.gguf.dequant import GGML_Q4_0, GGML_Q6_K, dequantize, row_bytes
...
# --------------------------------------------------------------------------------------
# Weight loading: GGUF tensor names -> SparkLab gemma4 module params.
# --------------------------------------------------------------------------------------

# Per-layer 1:1 norm/scale tensors (gguf suffix -> sparklab module-relative name). All
...
class GGUFTiedLMHead:
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        from sparklab.layers.gguf import fused_mul_mat_gguf
...
def convert_gemma4_to_gguf(model, config: ModelConfig) -> None:
    ...
    """
    from sparklab.layers.gguf import GGUFEmbedding, GGUFLinear
