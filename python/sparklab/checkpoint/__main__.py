"""CLI: convert an HF safetensors checkpoint to a SparkLab Weight (FTW) checkpoint.

    sparklab checkpoint --model <hf_dir> --out <ftw_dir> \
...
def main(argv: list[str] | None = None, prog: str = "sparklab.checkpoint") -> int:
