...
separate, torch-native extension that sits alongside SparkLab's tvm-ffi kernels.
...
def _host_compiler() -> str | None:
    ...
    to an older gcc. Override with ``SPARKLAB_GGUF_HOST_CXX``.
    """
    override = os.environ.get("SPARKLAB_GGUF_HOST_CXX")
    if override:
        return override
