#include <sparklab/nccl227.h>
#include <sparklab/tensor.h>
#include <sparklab/utils.cuh>
#include <sparklab/utils.h>
...
public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("sparklab.NCCLWrapper", NCCLWrapper,
                                    tvm::ffi::Object);
