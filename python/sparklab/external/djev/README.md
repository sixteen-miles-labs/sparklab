...
The local modifications replace `pybase64` with standard-library `base64` and
require TLS 1.2 or newer in the unused upstream TLS helper. A test verifies the
original hash after undoing those two changes.
