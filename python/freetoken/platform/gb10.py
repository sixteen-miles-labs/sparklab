...
The engine remains import-compatible as ``freetoken`` while Spark Lab exposes a
single supported production profile. Collection is separated from assessment so
the policy is deterministic and unit-testable without CUDA hardware.
"""
