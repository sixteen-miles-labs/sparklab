...
| GLM-5.3 | Opt-in DFlash2-4 measured 1.29 tok/s and 2.085 s warm TTFT on a 256-token probe, 16.4% faster than the saved same-length target-only baseline. Exact greedy parity and completed-answer quality are unverified. Target-only remains the default; the separate draft has research/evaluation license restrictions. | [DFlash2 and native MTP](../benchmarks/gb10/results/GB10-GLM53-SPEC-003.json), [target-only](../benchmarks/gb10/results/GB10-GLM53-RESEARCH-OPT-002.json) |
